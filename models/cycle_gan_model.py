...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_mask_A', type=float, default=10.0, help='weight for mask cycle loss (A -> B -> A)')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'cycle_A_mask']
    ...
    def backward_G(self):
        ...
        lambda_mask_A = self.opt.lambda_mask_A
        ...
        # Forward Masked cycle loss || G_B(G_A(A)) - A|| * A_mask
        self.loss_cycle_A_mask = self.criterionCycle(self.rec_A * self.mask_A, self.real_A * self.mask_A) * lambda_mask_A
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_cycle_A_mask
